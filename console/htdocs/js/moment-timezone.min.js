...
!function (a, b) {
    ...
    function u() {
        var b = Array.prototype.slice.call(arguments, 0, -1), c = arguments[arguments.length - 1], d = k(c), e = a.utc.apply(null, b);
    ...
    var D = a.fn;
    a.tz = u, a.updateOffset = function (a, b) {
        var c;
    ...
    }, D.zoneName = v(D.zoneName), D.zoneAbbr = v(D.zoneAbbr), D.utc = w(D.utc);
